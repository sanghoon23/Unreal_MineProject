...
#include "Component/HM_PengMao/CHM_MaoAttackComp.h"
#include "Component/HM_PengMao/CHM_MaoHitComp.h"
#include "Component/HM_PengMao/CHM_MaoEquipComp.h"
#include "Component/CMeshParticleComp.h"

#include "CHM_PengMao.generated.h"

UCLASS()
class UE_DOITPROJECT_API ACHM_PengMao 
...
private:
	...
	UPROPERTY(VisibleAnywhere, Category = "Component")
		class UCHM_MaoEquipComp* EquipComp;

	UPROPERTY(VisibleAnywhere, Category = "Component")
		class UCMeshParticleComp* MeshParticleComponent;

	UPROPERTY(EditAnywhere, Category = "Particle")
		class UParticleSystem* P_PengMao_DeathSmoke;
